%dw 2.0
/**
 * Builds the First Data field-delimited payload for Unlock (release locked funds).
 * Transaction code: 2208 (UnlockTransactionCode)
 *
 * Field layout (adds field 79 = lockId compared to lock):
 *   SV.{merchantId} |1C 40{2208} |1C EA{sourceCode} |1C 42{merchantId}{terminalId}
 ...
 *   |1C 79{lockId} |1C 7F1212 [|1C 15{transactionId}]
 *
 * Request: { cardNumber, pin, amount, currencyCode, lockId, transactionId? }
 */
output text/plain
var sep = "|1C"
...
var lockId = req.lockId as String default ""
